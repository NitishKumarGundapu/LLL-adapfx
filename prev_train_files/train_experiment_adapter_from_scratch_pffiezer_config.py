...
from transformers.adapters import ConfigUnion, AdapterConfig, PfeifferConfig
...
#         import pdb;pdb.set_trace();
        ...
        adapter_config = ConfigUnion(
                            PfeifferConfig(mh_adapter=True, output_adapter=False, reduction_factor=2, non_linearity="relu"),
#                             AdapterConfig(mh_adapter=False, output_adapter=True, reduction_factor=8, non_linearity="relu"),
                            PfeifferConfig(mh_adapter=False, output_adapter=True, reduction_factor=2, non_linearity="relu")
                        )
...
#     import pdb;pdb.set_trace();
    if task_ids[0]==0:
        ...
        adapter_config = ConfigUnion(
                            PfeifferConfig(mh_adapter=True, output_adapter=False, reduction_factor=3, non_linearity="relu"),
#                             AdapterConfig(mh_adapter=False, output_adapter=True, reduction_factor=8, non_linearity="relu"),
                            PfeifferConfig(mh_adapter=False, output_adapter=True, reduction_factor=2, non_linearity="relu")
                        )
#         adapter_config =  ConfigUnion(PrefixTuningConfig(bottleneck_size=800), ParallelConfig(),)
