...
#     import pdb;pdb.set_trace();
    ...
    if task_ids[0]>0:
        ...
        adapter_model_path = os.path.join(adapter_dir, FINAL_SAVE_NAME)
        adapter_config_path = os.path.join(adapter_dir, CONFIG_NAME)
        adapter_model_config = CONFIG_CLASS.from_json_file(adapter_config_path)
        model = MODEL_CLASS(adapter_model_config).cuda()
        ...
        state_dict = torch.load(adapter_model_path)
