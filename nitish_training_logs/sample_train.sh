...
#alternate_odd
nohup python test_adapter_from_scratch.py --data_dir data --model_dir_root models --seq_train_type lll --model_name gpt2 --n_gpus 1 --n_workers 35 --n_train_epochs 20 --gen_lm_sample_percentage 0.2 --tasks sst srl woz.en --lm_lambda 0.2 > /raid/amana/Lamol_with_adaptergen/nitish_testing_logs/Testlogs_adapter_prefix_last_alternate_odd_layer_20_epochs.out
#first_4
...
#only adapters
nohup python test_adapter_from_scratch_1.py --data_dir data --model_dir_root model_ag --seq_train_type lll --model_name gpt2 --n_gpus 1 --n_workers 35 --n_train_epochs 10 --gen_lm_sample_percentage 0.2 --tasks sst srl woz.en --lm_lambda 0.2 > /raid/amana/Lamol_with_adaptergen/nitish_testing_logs/Testlogs_adapter_all_layers_layer.out
#only prefix tuning
nohup python test_adapter_from_scratch_1.py --data_dir data --model_dir_root model_ag --seq_train_type lll --model_name gpt2 --n_gpus 1 --n_workers 35 --n_train_epochs 10 --gen_lm_sample_percentage 0.2 --tasks sst srl woz.en --lm_lambda 0.2 > /raid/amana/Lamol_with_adaptergen/nitish_testing_logs/Testlogs_prefix_all_layers_layer.out
...
#alternate_odd
nohup python train_adapter_prefix_config_3.py --data_dir data --model_dir_root models --seq_train_type lll --model_name gpt2 --n_gpus 12 --n_workers 75 --fp32 --n_train_epochs 20 --gen_lm_sample_percentage 0.2 --tasks sst srl woz.en --lm_lambda 0.2 > /raid/amana/Lamol_with_adaptergen/nitish_training_logs/Trainlogs_adapter_prefix_last_alternate_odd_layer_20_epochs.out
#first_4
...
#only adapters
nohup python train_adapter_prefix_config_2.py --data_dir data --model_dir_root model_ag --seq_train_type lll --model_name gpt2 --n_gpus 12 --n_workers 75 --fp32 --n_train_epochs 10 --gen_lm_sample_percentage 0.2 --tasks wikisql sst srl woz.en --lm_lambda 0.2 > /raid/amana/Lamol_with_adaptergen/nitish_training_logs/Trainlogs_adapter_all_layer_4_tasks.out
#only prefix tuning
nohup python train_adapter_prefix_config_1.py --data_dir data --model_dir_root model_ag --seq_train_type lll --model_name gpt2 --n_gpus 12 --n_workers 75 --fp32 --n_train_epochs 10 --gen_lm_sample_percentage 0.2 --tasks wikisql sst srl woz.en --lm_lambda 0.2 > /raid/amana/Lamol_with_adaptergen/nitish_training_logs/Trainlogs_prefix_all_layer_4_tasks.out
